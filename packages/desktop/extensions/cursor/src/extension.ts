...
import { createCursorExtension, installCursorProjectHooks, type HarnessExtensionApi } from "@own-harness/desktop"
...
export function activate(context: vscode.ExtensionContext): HarnessExtensionApi {
  ...
  if (workspacePath !== undefined) {
    installCursorProjectHooks(workspacePath)
  }
  const extension = createCursorExtension(
    vscode,
    {
